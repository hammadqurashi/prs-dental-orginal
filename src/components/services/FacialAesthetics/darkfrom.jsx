  ...
  return (
    <Spin spinning={Loading}>
      ...
      <div className="flex gap-4">
        ...
        <textarea
          minLength={200}
          className="px-4 outline-none ring-1 ring-otblack focus:ring-1 focus:ring-otred rounded  my-3 transition-all w-full text-neutral-400 focus:text-neutral-600 py-4"
          placeholder="Message"
          name="message"
          required
          rows={5}
