...
const WhyChooseUs = () => {
  return (
    <section className=" container mx-auto px-10 my-40">
      <div className="lg:grid-cols-[35%_65%] grid-cols-[100%] contaier-grid gap-11 grid ">
        <div className="left">
          <div >
            <img className="image lg:w-80 w-full"
          ...
          <div class="intro">
            ...
            <div className="dilog">
              <div className="dilog-1">
                ...
                <p>
                  Pavan Bhogal, a passionate advocate for dental healthcare, had
                  a vision to revolutionize the field of dentistry. His dreams
                  were grounded in a deep commitment to improving oral health
                  and overall well-being for people worldwide. His journey began
                  with a strong educational foundation in dentistry, and his
                ...
                <p>
                  ...
                  his dream. However, we believe that his vision should not
                  remain unfulfilled. The Pavan Bhogal Memorial Dental Clinic
              ...
              <div className="dilog-1">
                ...
                <p>
                  ...
                  he supplied Warwickshire County Council with cutting-edge air
